...
echo "<INFO> Installing Fhem Sources..."
mv -v /tmp/fhem/* $ARGV5/data/plugins/$ARGV3/
rm -r -v /tmp/fhem

# Replacing Vars
/bin/sed -i "s:REPLACEFOLDERNAME:$ARGV3:g" $ARGV5/config/plugins/$ARGV3/fhem.cfg
/bin/sed -i "s:REPLACEINSTALLFOLDER:$ARGV5:g" $ARGV5/config/plugins/$ARGV3/fhem.cfg
